"""
ZipVoice Vietnamese TTS — CLI (profile-driven, no pipeline editing).
"""
...
from config import OUTPUT_DIR, ensure_ffmpeg_on_path, models_ready
...
def cmd_synthesize(args: argparse.Namespace) -> int:
    ...
    logger.info(
        "CLI synthesize | profile=%s | gen_len=%d | mode=%s",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cli_tts",
        description="ZipVoice Vietnamese TTS CLI — load full config from profiles/",
    )
