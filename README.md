...
- **Pipeline chuẩn hóa** danh sách tùy chỉnh (mặc định **trống**): VieNeu / Cấu trúc TTS / vinorm / vietnormalizer / sea-g2p — preset **Sách/Audiobook** gợi ý 3 bước
...
| **Cấu trúc TTS** | Không | `mẫu (mẹ)`→`mẫu, mẹ`; `một. đoạn`→xuống dòng + nghỉ ~1s (`period_linebreak.py`) |
