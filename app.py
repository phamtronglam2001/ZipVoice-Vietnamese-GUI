...
def infer_tts(
    ...
    try:
        ...
        logger.info(
            ...
            "infer_tts | asset=%s | gen_len=%d | ref_len=%d | export=%s | norm=%s | mode=%s | chunk=%d",
        ...
        status = (
            ...
            f"(max {chunk_max_chars} ký tự/chunk, ~{est_min} phút CPU ước tính){resume_note}\n\n"
        ...
        return str(saved), (engine.sampling_rate, final_wave), spec_path, status, norm_full_preview
